...
export const CampaignRefinementModal: React.FC<CampaignRefinementModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 space-y-5 shadow-2xl">
        ...
        <form onSubmit={handleRefineCampaign} className="space-y-4">
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={4}
              className="w-full p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 focus:border-purple-500 rounded-2xl text-xs text-slate-900 dark:text-white outline-none resize-none"
              required
            />
          </div>
